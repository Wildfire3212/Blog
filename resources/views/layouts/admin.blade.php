            ...
            <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link active py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{route('index.categorias')}}">Categorias</a>
                    </li>
                    @guest
                    <li class="nav-item mx-0 mx-lg-1">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            @if(Auth::user()->admin)
                            <li class="mx-0 mx-lg-1"><a class="dropdown-item py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="{{route('main')}}">Volver a usuario</a></li>
                            @endif
